...
//    @Published public var mainPDFViewStatus: MainPDFViewStatus = .main
...
//                self.useCase.editPDF(paperInfo)
//            }
...
//                print(self)
                ...
                // TODO: Figure 플로팅이 되어있는 상태에서 나갈 시 fatal error 발생(Optional unwrapping error)
